    ...
    public partial class TravelExpertsContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=RAMMAH\\MYSQLSERVER2022;Database=travelexperts;Trusted_Connection=True;TrustServerCertificate=True;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Affiliations>(entity =>
            {
                ...
                entity.HasIndex(e => e.AffilitationId).IsClustered(false);
            ...
            modelBuilder.Entity<BookingDetails>(entity =>
            {
                ...
                entity.HasIndex(e => e.BookingDetailId).IsClustered(false);
      ...
      .HasConstraintName("FK_BookingDetails_Bookings");
            ...
            modelBuilder.Entity<Bookings>(entity =>
            {
                ...
                entity.HasIndex(e => e.BookingId).IsClustered(false);
            ...
            modelBuilder.Entity<Classes>(entity =>
            {
                ...
                entity.HasIndex(e => e.ClassId).IsClustered(false);
            ...
            modelBuilder.Entity<CreditCards>(entity =>
            {
                ...
                entity.HasIndex(e => e.CreditCardId).IsClustered(false);
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.HasIndex(e => e.CustomerId).IsClustered(false);
            ...
            modelBuilder.Entity<CustomersRewards>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.CustomerId, e.RewardId }).IsClustered(false);
            ...
            modelBuilder.Entity<Fees>(entity =>
            {
                ...
                entity.HasIndex(e => e.FeeId).IsClustered(false);
            ...
            modelBuilder.Entity<Packages>(entity =>
            {
                ...
                entity.HasIndex(e => e.PackageId).IsClustered(false);
            ...
            modelBuilder.Entity<PackagesProductsSuppliers>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.PackageId, e.ProductSupplierId }).IsClustered(false);
            ...
            modelBuilder.Entity<Products>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductId).IsClustered(false);
            ...
            modelBuilder.Entity<ProductsSuppliers>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductSupplierId).IsClustered(false);
            ...
            modelBuilder.Entity<Regions>(entity =>
            {
                ...
                entity.HasIndex(e => e.RegionId).IsClustered(false);
            ...
            modelBuilder.Entity<Rewards>(entity =>
            {
                ...
                entity.HasIndex(e => e.RewardId).IsClustered(false);
            ...
            modelBuilder.Entity<SupplierContacts>(entity =>
            {
                ...
                entity.HasIndex(e => e.SupplierContactId).IsClustered(false);
            ...
            modelBuilder.Entity<Suppliers>(entity =>
            {
                ...
                entity.HasIndex(e => e.SupplierId).IsClustered(false);
            ...
            modelBuilder.Entity<TripTypes>(entity =>
            {
                ...
                entity.HasIndex(e => e.TripTypeId).IsClustered(false);
